...
//! StormBreaker benchmark extension. Must be called before initialization.
//! Disabling the global span cache returns overflow spans directly to the OS.
RPMALLOC_EXPORT int
rpmalloc_set_global_cache_enabled(int enabled);

//! StormBreaker benchmark extension. Valid multipliers are 0..8.
RPMALLOC_EXPORT int
rpmalloc_set_global_cache_multiplier(size_t multiplier);

//! StormBreaker benchmark extension. Valid limits are 0..400 spans.
RPMALLOC_EXPORT int
